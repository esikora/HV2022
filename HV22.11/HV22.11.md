...
We retrieve the flag by calling `get_secret_value` with the ARN as parameter and deserializing the value of `SecretString`:
...
> Oh Hai! Santa made us split the flag up, he gave this part to me and told me to put it somewhere safe, I figured this was the best place.  The other half he gave to another Elf and told him the same thing, but that Elf told me he just threw it into a bucket!  That doesn't sound safe at all!

> M3r2y-Xm45_Yarr222_<3_Pirate}
