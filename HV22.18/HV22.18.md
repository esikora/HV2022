...
For gathering additional information on possible weaknesses of the functions and algorithms used in zip encryption, I looked through the articles on [SHA-1](https://en.wikipedia.org/wiki/SHA-1), [HMAC](https://en.wikipedia.org/wiki/HMAC), [PBKDF2](https://en.wikipedia.org/wiki/PBKDF2), [AES](https://en.wikipedia.org/wiki/Advanced_Encryption_Standard), [CBC](https://en.wikipedia.org/wiki/Block_cipher_mode_of_operation#Cipher_block_chaining_(CBC)). Indeed, I found the essential hint in the PBKDF2 article in the section about HMAC collisions:
