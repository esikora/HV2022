...
Although manual typing is possible, it is very time-consuming and only of limited use as the credentials expire. Commin off-the-shelf OCR (optical character recognition) tools produce a high amount of errors, and finding these errors is as time-consuming as manual typing.
