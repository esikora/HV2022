...
Apart from this, endowing (untrusted) clients with the control over URLs that are requested by the server imposes an inherent security risk. It should be considered in the application design to allocate such functionality on the client side.
